...
On your Redmine server, navigate to <tt>Administration >> Settings</tt>.

On tab <tt>Authentication</tt> or <tt>API</tt>, locate the <tt>Enable REST web service</tt> checkbox and check it if it is not already.
...
If you have a problem, please report it on the github project - https://github.com/joaopedrotaveira/redmine_mylyn_connector.
...
If you've added something, why not share it. Fork the repository (https://github.com/joaopedrotaveira/redmine_mylyn_connector), make the changes and send a pull request to the maintainers.
...
This plugin was maintained by Daniel Munn <https://github.com/danmunn>

This plugin is currently maintained by many, namely:
- Kranke Kirill <https://github.com/krtkr>
- João Pedro Taveira <https://github.com/joaopedrotaveira>
- David Santos <https://github.com/Dawuid>
- yukoff <https://github.com/yukoff>
